...
def get_production_orders(
    ...
    return (
        service.get_all_production_orders()
    )
...
def get_production_order_by_number(
    ...
    production_order = (
        service.get_production_order_by_number(
            production_number
        )
    )
...
def get_production_order_detail(
    ...
    production_order = (
        service.get_production_order_detail(
            production_order_id
        )
    )
...
def start_production_operation(
    operation_id: int,
    db: Session = Depends(get_db),
    current_user: User = Depends(
        require_role(
